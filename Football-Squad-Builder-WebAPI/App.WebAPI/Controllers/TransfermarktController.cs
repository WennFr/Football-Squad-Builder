...
namespace App.WebAPI.Controllers
{
    ...
    public class TransfermarktController : ControllerBase
    {
        ...
        public TransfermarktController(ITransfermarktAPIService transfermarktAPIService)
        {
        ...
        public async Task<ActionResult<List<PlayerDTO>>> GetPlayersByClub(string clubId)
        {
            ...
            {
                var playerProfileDTO = await _transfermarktAPIService.GetPlayerProfile(player.Id, client);
